...
CREATE TABLE `t_admin` (
  ...
  `encrypt`     varchar(6) NOT NULL DEFAULT '' COMMENT '加密盐值',
  ...
  `wechat`      varchar(20) NOT NULL DEFAULT '' COMMENT '微信账号',
  `weibo`       varchar(20) NOT NULL DEFAULT '' COMMENT '微博账号',
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='后台菜单表' ;
